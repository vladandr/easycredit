...
namespace EasyCredit.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> VerifyCode(
            int codeNumber, string provider, string returnUrl, bool rememberMe)
        {
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Failure:
                default:
                    ModelState.AddModelError("", "Invalid code or time expired");
                    return View(model);
            }
        }
...
//                    return RedirectToAction("Index", "Home");
        ...
        public async Task<ActionResult> SendCode(string returnUrl, bool rememberMe)
        {
            ...
            string provider = userFactors.First(s => s == EasyCreditConstants.CardCodeProvider);
            string index = await SignInManager.GetCardCodeIndexAsync(provider);
...
//            // Generate the token
//
//            string index = await SignInManager.GetCardCodeIndexAsync(model.SelectedProvider);
//
//            return RedirectToAction(nameof(VerifyCode), new VerifyCodeViewModel
//            {
